      ...
      <div className="min-h-screen">
        ...
        <main className="pt-20 flex items-center justify-center min-h-[60vh]">
          <div className="text-center space-y-4">
            ...
            <Link to="/collections">
              <Button variant="outline" className="rounded-none tracking-wider uppercase text-xs font-body">
                Browse Collections
              </Button>
            </Link>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 pb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="space-y-4">
              ...
              {/* Thumbnail strip (same image as placeholder for gallery feel) */}
            ...
            <div className="flex flex-col justify-center space-y-8">
              ...
              {/* Size Selection */}
              <div className="space-y-3">
                <p className="text-sm font-body tracking-[0.2em] uppercase text-foreground">
                  Select Size
                </p>
                <RadioGroup
                ...
                >
                  {product.sizes.map((size, i) => (
                    <div key={size.label}>
                      ...
                      <Label
                        htmlFor={`size-${i}`}
                        className="flex flex-col items-center gap-1 border border-border px-6 py-3 cursor-pointer peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/5 transition-colors hover:border-primary/50"
                      >
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex-1">
                  <Button
                    variant="outline"
                    className="w-full rounded-none h-12 tracking-wider uppercase text-xs font-body border-green-600 text-green-700 hover:bg-green-50 hover:text-green-800"
                  >
