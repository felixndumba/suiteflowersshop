...
const collections = [
  {
    ...
    items: [
      { name: "Bridal Bliss", price: "$120", image: productBridal },
      { name: "Crimson Romance", price: "$89", image: productRomance },
      { name: "Peaceful Grace", price: "$95", image: productSympathy },
    ],
  },
  {
    ...
    items: [
      { name: "Spring Awakening", price: "$65", image: productSpring },
      { name: "Tropical Paradise", price: "$85", image: productTropical },
      { name: "Desert Bloom", price: "$75", image: productDried },
    ],
  },
];
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {collection.items.map((product) => (
                  <Card key={product.name} className="group border-0 shadow-none bg-transparent overflow-hidden cursor-pointer">
