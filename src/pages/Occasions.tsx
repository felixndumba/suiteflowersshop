...
const occasions = [
  ...
  { name: "Special Days",  description: "Make every special moment count with a thoughtful and beautifully arranged bouquet." , icon: HeartHandshake, color: "text-accent", tags: ["Dried"] },
];
